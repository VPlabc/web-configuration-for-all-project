...
#define WIFI_EVENT_STA_MODE_CONNECTED SYSTEM_EVENT_STA_CONNECTED
#define WIFI_EVENT_STA_MODE_DISCONNECTED SYSTEM_EVENT_STA_DISCONNECTED
#define WIFI_EVENT_AP_STAMODE_DISCONNECTED SYSTEM_EVENT_AP_STADISCONNECTED
#ifdef ESP32
#define WIFI_EVENT_AP_MODE_DISCONNECTED SYSTEM_EVENT_AP_STADISCONNECTED
#else
#define WIFI_EVENT_APMODE_DISCONNECTED WIFI_EVENT_SOFTAPMODE_STADISCONNECTED
#endif
#define WIFI_EVENT_STA_MODE_GOT_IP SYSTEM_EVENT_STA_GOT_IP
...
const char DEFAULT_STA_SSID []  PROGMEM =        "Xiaomi 12T";
