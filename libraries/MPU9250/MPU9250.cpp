...
{  
 ...
 // With the MPU9250, it is possible to get gyro sample rates of 32 kHz (!), 8 kHz, or 1 kHz
  writeByte(MPU9250_ADDRESS, CONFIGURE , 0x03);  
...
// Configure MPU6050 gyro and accelerometer for bias calculation
  writeByte(MPU9250_ADDRESS, CONFIGURE , 0x01);      // Set low-pass filter to 188 Hz
...
void MPU9250::selfTest() // Should return percent deviation from factory trim values, +/- 14 or less deviation is a pass
{
  ...
  writeByte(MPU9250_ADDRESS, CONFIGURE , 0x02);        // Set gyro sample rate to 1 kHz and DLPF to 92 Hz
